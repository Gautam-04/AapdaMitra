...
function Fundraiser() {
    ...
    const createFundraiser = async () => {
        try {
            const response = await axios.post('/api/v1/donation/create-fundraiser', newFundraiser, {
            ...
            <div className="fundraiser-container">
                ...
                <div className="fundraiser-cards">
                    {fundraisers.map((fundraiser) => (
                        <Card key={fundraiser._id} style={{ width: '18rem', margin: '10px' }}>
                            <Card.Img
                                variant="top"
                    ...
                    <Form>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) =>
                                    setNewFundraiser({ ...newFundraiser, fullForm: e.target.value })
                                }
                            />
                        </Form.Group>
                        <Form.Group className="mb-3">
